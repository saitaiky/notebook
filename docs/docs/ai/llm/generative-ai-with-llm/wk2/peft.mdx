...
description: 'Source: Scaling Down to Scale Up: A Guide to Parameter-Efficient Fine-Tuning.'
sidebar_position: 2
keywords:
  - ai
  - llm
...
![perf-taxonomy](/img/ai/llm/peft/perf-taxonomy.png)

Source: [Scaling Down to Scale Up: A Guide to Parameter-Efficient Fine-Tuning](https://arxiv.org/abs/2303.15647)
...
For how LoRA specifically is offered as a managed Bedrock feature — swappable adapters against a shared base model — see [Amazon Bedrock: model customization](/aws/ai/bedrock#model-customization-fine-tuning-distillation-and-lora).
:::
