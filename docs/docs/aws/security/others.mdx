...
description: Security features including Cognito authentication for ALB, security groups as virtual firewalls, ACM certificate validation, and API request signing.
keywords:
  - aws
  - amazon web services
  - security
