...
description: Network protocol stack with OSI and TCP/IP models describing data transmission through physical, link, network, transport, and application layers.
keywords:
  - aws
  - amazon web services
  - networking
  - fundamental
  - protocol and layers aws
  - protocol and layers guide
  - networking on aws
  - protocol and layers tutorial
---
...
:::info TCP/IP is the most commonly used protocol suite used today
