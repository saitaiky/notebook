---
title: UDP & TCP
description: Transport protocols with TCP emphasizing reliable ordered delivery and UDP prioritizing speed with lower overhead for real-time applications.
keywords:
  - aws
  - amazon web services
  - networking
