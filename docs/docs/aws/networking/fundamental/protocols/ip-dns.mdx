...
description: Static IP address management and DNS resolution with subnet masks, ephemeral ports, and host identification for IP-based communication.
keywords:
  - aws
  - amazon web services
  - networking
  - fundamental
  - static and public ip, dns aws
  - static and public ip, dns guide
  - networking on aws
  - static and public tutorial
---
...
When you connect to a web server, your browser (the client) uses an ephemeral port to establish a connection. For example, if your computer's IP address is `
...
## What happens when you type a URL into a broswer

![what-happens-when-you-type-a-url-into-a-broswer](/img/aws/networking/fundamental/what-happens-when-you-type-a-url-into-a-broswer.png)

Source: [ByteByteGo: Alex Xu](https://x.com/alexxubyte/status/1949132976932954149/photo/1)
