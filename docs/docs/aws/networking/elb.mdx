...
title: ELB
sidebar_position: 2
description: Load balancing service with ALB for layer 7 routing, NLB for TCP/UDP and extreme performance, supporting health checks and cross-zone distribution.
keywords:
  - aws
  - amazon web services
  - networking
...
:::warning ALB and CLB also support SSL/TLS Termination
...
:::warning By default cross-zone load balancing is enabled
