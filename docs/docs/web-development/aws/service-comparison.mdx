...
![cdk-vs-cloudformation](/img/web-development/aws/cdk-vs-cloudformation.jpg "cdk and cloudformation")
...
![kinesis-consumer](/img/web-development/aws/kinesis-consumer.png "kinesis-consumer")
