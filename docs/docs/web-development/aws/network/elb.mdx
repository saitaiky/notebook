...
![elb-healthcheck-setting](/img/web-development/aws/network/elb-healthcheck-setting.png "elb-healthcheck-setting")
...
![component_architecture](/img/web-development/aws/network/component_architecture.png "component_architecture")
