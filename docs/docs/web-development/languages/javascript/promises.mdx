...
![Promise concept](/img/web-development/languages/javascript/promise.png)
...
![Promise concept](/img/web-development/languages/javascript/promise-chain.png)
```js
...
![Promise concept](/img/web-development/languages/javascript/promise-newbie-mistake.png)
```js
