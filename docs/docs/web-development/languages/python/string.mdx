...
![python-format-positional-argument](/img/web-development/languages/python/python-format-positional-argument.jpg)
source: https://www.programiz.com/python-programming/methods/string/format

#### For keyword arguments
![python-format-keyword-argument](/img/web-development/languages/python/python-format-keyword-argument.jpg)
source: https://www.programiz.com/python-programming/methods/string/format
