...
![monolithic-architectur](/img/web-development/aws/system-design/monolithic-architecture.jpg)
...
![microservice-architectur](/img/web-development/aws/system-design/microservice-architecture.jpg)
...
- [Decompose by subdomain](https://docs.aws.amazon.com/prescriptive-guidance/latest/modernization-decomposing-monoliths/decompose-subdomain.html)
  - The “Sales” and “Marketing” services are broken down into smaller microservices. 
    - The "Purchasing" and "Claims” models are important business differentiators for "Sales," and are split into two separate microservices. 
    - "Marketing" is decomposed by using supporting business functionalities, such as "Campaigns," "Analytics," and "Reports."
