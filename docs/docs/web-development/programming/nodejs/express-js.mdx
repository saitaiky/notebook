...
![Middleware](/img/web-development/programming/nodejs/MiddlewareChaining.png)
...
```
![Middleware-result](/img/web-development/programming/nodejs/middleware-result.png)
Source: [Middleware in Express.js](https://www.geeksforgeeks.org/middleware-in-express-js/)
