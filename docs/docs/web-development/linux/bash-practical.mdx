...
![streams](/img/web-development/linux/redirection.jpg)
...
```
![command](/img/web-development/linux/cmd_1.gif)
...
![pip flow image](/img/web-development/linux/pip-flow.jpg)
...
## Command substitution vs. Piping
