...
- SSE-S3, you can..
  - Audit trail and lifecycle management is not possible

### S3 Access Points

> TL;DR - A indepentent DNS access folder which you can use access poing policy to control permission, so that you don't need to create a complicated S3 bucket policy for multiple group of users.
