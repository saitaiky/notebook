...
![](/img/aws/networking/vpc/vpc-endpoints-vs-interface-endpoint.png)
...
<div class="table-container"><div class="table-contents disable-scroll"><table id="w285aac11c11b5"><thead>
    ...
    <tbody><tr>
      <td>VPC size</td>
      <td>Up to 5 CIDRs from /16 to /28. This <a href="./amazon-vpc-limits.html#vpc-limits-vpcs-subnets">quota</a> is adjustable.</td>
    ...
    <tr>
      ...
      <td>Requires an <a href="./VPC_Internet_Gateway.html">internet gateway</a>.</td>
      <td>Requires an internet gateway. Supports outbound-only communication using an <a href="./egress-only-internet-gateway.html">egress-only internet gateway</a>.</td>
    </tr>
    <tr>
