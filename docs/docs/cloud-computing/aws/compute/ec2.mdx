...
:::infoUpgrade and downgrade instance type
...
:::infoMake sure instance profile has enough permission to access other AWS services
...
:::cautionAWS Backup does not reboot EC2 instances at any time.
