...
- To maintain **file system integrity** you need to provide the reboot parameter while taking images (EventBridge + Lambda + **CreateImage API with reboot paramenter**)
