...
- Automation
  - **EC2 Image Builder** is a service AWS offer that allows you to automate the process of building custom Amazon Machine Images (AMIs). It also handles the full pipeline for creating, testing and even distributing the machine images.
