...
![initial-diagram](/img/software-development/others/css/initial-diagram.jpg)
H1 is looking to inherit a color value, which it finds in the body element.

![initial-diagram-inherit](/img/software-development/others/css/initial-diagram-inherit.jpg)
