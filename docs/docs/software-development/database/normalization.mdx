...
![reason-of-normalization](/img/software-development/others/normalization/reason-of-normalization.png)
...
#### Update Anomaly
![update-anomaly](/img/software-development/others/normalization/update-anomaly.png)
...
#### Deletion Anomaly
![deletion-anomaly](/img/software-development/others/normalization/deletion-anomaly.png)
...
![reason-of-normalization](/img/software-development/others/normalization/normalization-process.png)
...
![normalizationtable1](/img/software-development/others/normalization/normalizationtable1.png)
...
Before 1NF
![1NF-2](/img/software-development/others/normalization/1NF-2.png)
After 1NF
![1NF-3](/img/software-development/others/normalization/1NF-3.png)
...
![2NF-1](/img/software-development/others/normalization/2NF-1.png)
...
After 2NF
![2NF-2](/img/software-development/others/normalization/2NF-2.png)
...
![3NF](/img/software-development/others/normalization/3NF-1.png)

This table we have Customer ID as primary key
![3NF](/img/software-development/others/normalization/3NF-2.png)
...
![transitive_functional_dependencies](/img/software-development/others/normalization/transitive_functional_dependencies.png)
