...
![monolithic-architecture](/img/software-development/system-design/monolithic-architecture.jpg)
...
:::info Are event-driven and microservices architecture the same thing?
