...
In the [exactly-once](/software-development/system-design/sync-async/queue/exact-once) page, we will look at this in more detail.
:::
...
![event-driven-architecture-example](/img/software-development/system-design/sync-async/queue/at-least-once.png)
...
![at-least-once](/img/software-development/system-design/sync-async/queue/atotm-at-least-once-07.png)
Source: [How Akka Works: 'At Least Once' Message Delivery](https://www.lightbend.com/blog/how-akka-works-at-least-once-message-delivery)
...
![at-least-once](/img/software-development/system-design/sync-async/queue/atotm-at-least-once-10.png)
Source: [How Akka Works: 'At Least Once' Message Delivery](https://www.lightbend.com/blog/how-akka-works-at-least-once-message-delivery)
...
![at-least-once](/img/software-development/system-design/sync-async/queue/atotm-at-least-once-11.png)
Source: [How Akka Works: 'At Least Once' Message Delivery](https://www.lightbend.com/blog/how-akka-works-at-least-once-message-delivery)
...
You can now go to the [exactly-once](/software-development/system-design/sync-async/queue/exact-once) page. While theoretically, an exactly-once approach for message delivery is appealing once we look into the challenges and limitations I think you will see that the at-least-once approach is a more practical way to go.