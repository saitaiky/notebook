---
title: "Data management for microservice architecture"
description: Data management
keywords:
  - Data management
---

![mono-micro-data-managemen](/img/software-development/system-design/data/mono-micro-data-management.webp)

Source: [Microservices Data Management](https://medium.com/design-microservices-architecture-with-patterns/microservices-data-management-3235893b7c29)
...
style Service_A fill:#f9f,stroke:#333,stroke-width:2px
style Service_B fill:#f9f,stroke:#333,stroke-width:2px
style Service_C fill:#f9f,stroke:#333,stroke-width:2px
```
...
![enabling-diagram4](/img/software-development/system-design/data/current-state.png.webp)
...
![enabling-diagram4](/img/software-development/system-design/data/event-sourcing.webp)
...
![enabling-diagram4](/img/software-development/system-design/data/event-sourcing-architecture.svg)
...
![enabling-diagram4](/img/software-development/system-design/data/enabling-diagram4.png)
...
![enabling-diagram5](/img/software-development/system-design/data/enabling-diagram5.png)
Source: [Event sourcing pattern](https://docs.aws.amazon.com/prescriptive-guidance/latest/modernization-data-persistence/service-per-team.html)
...
**CQRS**
![CQRS-in-general](/img/software-development/system-design/data/CQRS-in-general.svg)
Source: [EventStore - A Beginner’s Guide to Event Sourcing](https://www.eventstore.com/event-sourcing#CQRS)

**AWS implementation**
![CQRS-AWS](/img/software-development/system-design/data/CQRS-AWS.png)
...
![From_2PC_To_Saga](/img/software-development/system-design/data/From_2PC_To_Saga.png)
...
![event-bridge](/img/software-development/system-design/data/sega-choreography.png)
...
![event-bridge](/img/software-development/system-design/data/event-bridge.png)
...
![event-bridge](/img/software-development/system-design/data/sega-orchestration.png)
Source: [AWS-Building a serverless distributed application using a saga orchestration pattern](https://aws.amazon.com/blogs/compute/building-a-serverless-distributed-application-using-a-saga-orchestration-pattern/)

![step-functions](/img/software-development/system-design/data/step-functions.png)
Source: [Choreography vs Orchestration in the land of serverless](https://theburningmonk.com/2020/08/choreography-vs-orchestration-in-the-land-of-serverless/)

### Why the hybrid approach is bad

![sega-hybrid](/img/software-development/system-design/data/sega-hybrid.png)
Source: [Choreography vs Orchestration in the land of serverless](https://theburningmonk.com/2020/08/choreography-vs-orchestration-in-the-land-of-serverless/)
...
![sega-pub-sub.png](/img/software-development/system-design/data/sega-pub-sub.png)
Source: [Choreography vs Orchestration in the land of serverless](https://theburningmonk.com/2020/08/choreography-vs-orchestration-in-the-land-of-serverless/)
