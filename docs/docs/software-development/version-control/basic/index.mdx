...
![git-transport.png](/img/software-development/version-control/git-transport.png)
...
![HEAD.001](/img/software-development/version-control/HEAD.001.png)
...
![HEAD.004](/img/software-development/version-control/HEAD.004.png)
...
You need to create a repository manually before pushing to a remote repository. There are some tools for you if you fancy to use your local CLI to create repositories. such as [hub](https://hub.github.com/)
...
```
:::info Merge Conflict Indicators Explanation

![streams](/img/software-development/version-control/merge_conflict.gif)
