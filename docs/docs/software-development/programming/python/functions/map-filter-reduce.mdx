...
1. **First class function**
    1. map(function_to_apply, iterable_of_elements)
    2. filter(function_to_apply, iterable_of_elements)
    3. reduce(function_to_apply, iterable_of_elements)
1. lambda
...
![s5_reduce_function](/img/software-development/programming/python/s5_reduce_function.png)
