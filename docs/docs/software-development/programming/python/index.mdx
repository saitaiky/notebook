...
Check <Link to="/software-development/programming/python/modules-packages">Modules and Packages</Link> if you want to know more about how Python's name space works.
