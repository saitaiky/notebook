...
In addition to [Promises](/software-development/programming/javascript/promises/), there is a new syntax you might encounter to handle asynchronous code named *async / await*.
