...
![nodejs-eventloop](/img/software-development/programming/javascript/nodejs-eventloop.png)
...
![eventloop](/img/software-development/programming/javascript/eventloop.gif)
