...
![Promise concept](/img/software-development/programming/javascript/promise.png)
...
![Promise concept](/img/software-development/programming/javascript/promise-chain.png)
```js
...
![Promise concept](/img/software-development/programming/javascript/promise-newbie-mistake.png)
```js
